        ...
        <div class="card-body">
            <form action="{{route('admin.tags.store')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Ingrese el nombre de la etiqueta..." value="{{old('name')}}">
                ...
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" id="slug" name="slug" readonly placeholder="Ingrese el slug de la etiqueta..." value="{{old('slug')}}">
